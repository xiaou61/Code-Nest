...
本页来自 2026-04-24 本地全功能截图测试。完整原始记录在 `AI-DOCS/User/操作指南/Code-Nest本地功能操作手册.md`。
...
| 类型 | 路径 |
| --- | --- |
| 原始手册 | `AI-DOCS/User/操作指南/Code-Nest本地功能操作手册.md` |
| 用户端截图 | `AI-DOCS/assets/images/2026-04-24/user` |
| 管理端截图 | `AI-DOCS/assets/images/2026-04-24/admin` |
