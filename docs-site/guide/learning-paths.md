...
| 4 | [本地开发](/guide/local-dev) | 本地后端、用户端、管理端、文档站分别怎么启动 |
| 5 | [模块总览](/modules/) | 功能如何按学习、内容、平台能力、工具和后台分组 |
| 6 | [功能开发流程](/guide/feature-development) | 新增功能时怎么从需求边界走到验证交接 |
| 7 | [发布前验证](/guide/release-verification) | 改不同范围时应该跑哪些构建、接口和页面烟测 |
