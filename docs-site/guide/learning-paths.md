...
| 11 | [发布前验证](/guide/release-verification) | 改不同范围时应该跑哪些构建、接口和页面烟测 |
...
| 6 | [权限与安全边界](/guide/security-boundaries) | 接口权限、当前用户、文件和后台高风险操作 |
| 7 | [响应体与错误码](/reference/response-errors) | 统一返回、登录失效、权限错误和文件错误 |
...
| 8 | [验证记录与已知问题](/manuals/verified-scenarios) | 真实验证结果和已知缺口 |
| 9 | [v2.2.0 文档计划](/roadmap/v2.2.0-docs-plan) | 已完成阶段和后续补强节奏 |
