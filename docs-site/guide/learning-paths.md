...
| 5 | [发布前验证](/guide/release-verification) | 改不同范围时应该跑哪些构建、接口和页面烟测 |

如果这 5 页读完后你能说清楚“我要改某个功能时从哪个前端路由、哪个 Controller、哪个表开始查”，后面就可以按角色深入。
...
| 2 | [全功能覆盖矩阵](/reference/feature-coverage) | 检查功能是否有用户入口、管理入口、API、表和模块页 |
| 3 | [模块总览](/modules/) | 模块页统一模板和依赖关系 |
| 4 | [核心链路教程](/manuals/core-workflows) | 用户视角的端到端流程 |
| 5 | [验证记录与已知问题](/manuals/verified-scenarios) | 真实验证结果和已知缺口 |
| 6 | [v2.2.0 文档计划](/roadmap/v2.2.0-docs-plan) | 已完成阶段和后续补强节奏 |
