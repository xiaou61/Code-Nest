...
| 模块 | 关系 | 说明 |
| --- | --- | --- |
| [公共底座](/modules/common) | 强依赖 | 工具模块依赖公共底座的统一响应和异常处理 |
| [鉴权与用户体系](/modules/auth) | 间接依赖 | 部分工具可能需要用户登录态 |
| [开发者工具](/modules/dev-tools) | 强依赖 | 开发者工具是工具模块的子集 |
| [摸鱼工具](/modules/moyu) | 强依赖 | 摸鱼工具是工具模块的子集 |
| [版本历史](/modules/version-history) | 强依赖 | 版本历史是工具模块的子集 |
