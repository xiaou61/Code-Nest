...
-- ----------------------------
-- Table structure for sys_agent_audit
-- ----------------------------
DROP TABLE IF EXISTS `sys_agent_audit`;
...
-- ----------------------------
-- Table structure for sys_agent_session_context
-- ----------------------------
DROP TABLE IF EXISTS `sys_agent_session_context`;
CREATE TABLE `sys_agent_session_context`  (
